...
<body id="page-top">
              ...
              <!-- Begin Page Content -->
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Equipment Return</h1>
                        <!--
                                        ...
                                        <tbody id="userInfo_tbody">
                                           <%
                                               ...
                                               for (ReturnBean b :returnBeans) {
                                                   ...
                                                   out.println("<td><button type='button' class='btn btn-danger'  onclick='return_Equipment("+b.getBorrowID()+", "+b.getEquipmentEachID()+")'>Return</button></td>");
                                                   out.println("</tr>");
    ...
    <jsp:include page="Tech_logout.jsp"></jsp:include>
                                    ...
                                    <script>
                                       function return_Equipment(Borrow_ID, Equipment_Each_ID){
                                        var r=confirm("Are you sure Return Equipment Each ID: " + Equipment_Each_ID+"?")
                                        if (r==true){
                                          $(function () {
                                            $.ajax({
                                               type: "post",
                                              ...
                                              data:{    
                                                Borrow_ID : Borrow_ID,
                                                Equipment_Each_ID : Equipment_Each_ID,
                                                Action : "Return"    
                                              }, 
                                              dataType:'text',
