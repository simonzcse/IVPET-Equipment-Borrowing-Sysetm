                    ...
                    <div class="row">
                        ...
                        <div class="alert alert-light" role="alert">
                            <table>
                              ...
                              <tr>
                                <td><button type='button' class='btn btn-warning' ><i class="fas fa-times    "></i></button></td>
                                <td>Change Status to Unavailable</td>
                              </tr>
                              <tr>
                                      ...
                                      <table class="table table-striped table-m">
                                        <thead>
                                          <tr>
                                            ...
                                            <th>Equipment Each is Borow</th>
                                            <th>Equipment Each is Available</th>
                                            <th>Action</th>
                                          </tr>
                                        </thead>
                                        <tbody id="userInfo_tbody">
                                           <%
                                                ...
                                                out.println("<td>" + b.getEquipment_Name() + "</td>");
                                                out.println("<td>" + b.getEquipment_Type() + "</td>");
                                                out.println("<td>" + b.getEquipment_Each_isBorow() + "</td>");
                                                out.println("<td>" + b.getEquipment_Each_isAvailable() + "</td>");
                                                out.println("<td>");
                                                out.println("<button type='button' class='btn btn-primary' onclick='edit("+b.getEquipment_ID()+")'><i class=\"fas fa-pencil-alt\"></i></button>");  
                                                if(b.getEquipment_Each_isAvailable().equals("Yes")){
                                                  out.println("<button type='button' class='btn btn-warning' onclick='unavailable("+b.getEquipment_Each_ID()+")'><i class=\"fas fa-times\"></i></button>");
                                                }else if(b.getEquipment_Each_isAvailable().equals("No")){
                                                  out.println("<button type='button' class='btn btn-success' onclick='available("+b.getEquipment_Each_ID()+")'><i class=\"fas fa-check\"></i></button>");
                                                }
                                                out.println("<button type='button' class='btn btn-danger' onclick='deleteEquipment("+b.getEquipment_Each_ID()+")'><i class=\"fas fa-trash\"></i></button>");
                                                out.println("</td>");
                                                out.println("</tr>"); 
                                                }
                                        %>
